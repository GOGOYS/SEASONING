	...
	<section>
		<article>
			...
			<a href="${rootPath}/football/fb-daegu">
				<div class="map-point" id="deagu" style="font-size: 18px; background-color: rgb(0, 24, 65);">대구 FC</div>
			</a>
				...
				<div id="menu_wrap" class="bg_white">
					<div class="around-tour-button">
						<form onsubmit="searchPlaces1(); return false;">
							<button id="keyword1" type="submit" value="대구광역시 북구 고성로 191 맛집">식당</button>
						</form>
						<form onsubmit="searchPlaces2(); return false;">
							<button type="submit" value="대구광역시 북구 고성로 191 숙박" id="keyword2">숙박</button>
						</form>
					</div>
					<hr>
					<ul id="placesList"></ul>
