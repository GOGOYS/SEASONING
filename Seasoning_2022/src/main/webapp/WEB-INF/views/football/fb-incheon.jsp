	...
	<section>
		<article>
			...
			<a href="${rootPath}/football/fb-incheon">
				<div class="map-point" id="incheon" style="font-size: 18px; background-color: rgb(0, 24, 65);">인천 UNT</div>
			</a>
				...
				<div id="menu_wrap" class="bg_white">
					<div class="around-tour-button">
						<form onsubmit="searchPlaces1(); return false;">
							<button id="keyword1" type="submit" value="인천광역시 중구 참외전로 246 맛집">식당</button>
						</form>
						<form onsubmit="searchPlaces2(); return false;">
							<button type="submit" value="인천광역시 중구 참외전로 246 숙박" id="keyword2">숙박</button>
						</form>
					</div>
					<hr>
					<ul id="placesList"></ul>
