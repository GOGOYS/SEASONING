	...
	<section>
		<article>
			...
			<a href="${rootPath}/football/fb-jeju">
				<div class="map-point" id="jeju" style="font-size: 18px; background-color: rgb(0, 24, 65);">제주 UNT</div>
			</a>
				...
				<div id="menu_wrap" class="bg_white">
					<div class="around-tour-button">
						<form onsubmit="searchPlaces1(); return false;">
							<button id="keyword1" type="submit" value="제주특별자치도 서귀포시 월드컵로 33 맛집">식당</button>
						</form>
						<form onsubmit="searchPlaces2(); return false;">
							<button type="submit" value="제주특별자치도 서귀포시 월드컵로 33 숙박" id="keyword2">숙박</button>
						</form>
					</div>
					<hr>
					<ul id="placesList"></ul>
