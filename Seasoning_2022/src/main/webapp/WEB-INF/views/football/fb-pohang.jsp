	...
	<section>
		<article>
			...
			<a href="${rootPath}/football/fb-pohang">
				<div class="map-point" id="pohang" style="font-size: 18px; background-color: rgb(0, 24, 65);">포항 스틸러스</div>
			</a>
				...
				<div id="menu_wrap" class="bg_white">
					<div class="around-tour-button">
						<form onsubmit="searchPlaces1(); return false;">
							<button id="keyword1" type="submit" value="경상북도 포항시 남구 동해안로6213번길 20 맛집">식당</button>
						</form>
						<form onsubmit="searchPlaces2(); return false;">
							<button type="submit" value="경상북도 포항시 남구 동해안로6213번길 20 숙박" id="keyword2">숙박</button>
						</form>
					</div>
					<hr>
					<ul id="placesList"></ul>
