	...
	<section>
		<article>
			...
			<a href="${rootPath}/football/fb-seongnam">
				<div class="map-point" id="seongnam" style="font-size: 18px; background-color: rgb(0, 24, 65);">성남 FC</div>
			</a>
				...
				<div id="menu_wrap" class="bg_white">
					<div class="around-tour-button">
						<form onsubmit="searchPlaces1(); return false;">
							<button id="keyword1" type="submit" value="경기도 성남시 분당구 탄천로 215 맛집">식당</button>
						</form>
						<form onsubmit="searchPlaces2(); return false;">
							<button type="submit" value="경기도 성남시 분당구 탄천로 215 숙박" id="keyword2">숙박</button>
						</form>
					</div>
					<hr>
					<ul id="placesList"></ul>
