...
<title>Season + ing ㅣ fb-suwon</title>
	...
	<section>
		<article>
			...
			<a href="${rootPath}/football/fb-suwon">
				<div class="map-point" id="suwon" style="font-size: 18px; background-color: rgb(0, 24, 65);">수원 FC</div>
			</a>
				...
				<div id="menu_wrap" class="bg_white">
					<div class="around-tour-button">
						<form onsubmit="searchPlaces1(); return false;">
							<button id="keyword1" type="submit" value="경기도 수원시 장안구 경수대로 893 맛집">식당</button>
						</form>
						<form onsubmit="searchPlaces2(); return false;">
							<button type="submit" value="경기도 수원시 장안구 경수대로 893 숙박" id="keyword2">숙박</button>
						</form>
					</div>
					<hr>
					<ul id="placesList"></ul>
