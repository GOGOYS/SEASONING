	...
	<section>
		<article>
			...
			<a href="${rootPath}/football/fb-suwon_ss">
				<div class="map-point" id="suwon_ss" style="font-size: 18px; background-color: rgb(0, 24, 65);">수원 삼성</div>
			</a>
				...
				<div id="menu_wrap" class="bg_white">
					<div class="around-tour-button">
						<form onsubmit="searchPlaces1(); return false;">
							<button id="keyword1" type="submit" value="경기도 수원시 팔달구 월드컵로 310 맛집">식당</button>
						</form>
						<form onsubmit="searchPlaces2(); return false;">
							<button type="submit" value="경기도 수원시 팔달구 월드컵로 310 숙박" id="keyword2">숙박</button>
						</form>
					</div>
					<hr>
					<ul id="placesList"></ul>
